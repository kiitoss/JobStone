...
const incorrect_sign_up = document.getElementById("incorrect-sign-up");
...
function sign_up(e) {
  ...
  RM.getUserByPseudo(pseudo, user => {
    ...
    RM.createNewUser(new User(null, pseudo, mail, "#" + Math.floor(Math.random()*16777215).toString(16), 1000), new_user => {
